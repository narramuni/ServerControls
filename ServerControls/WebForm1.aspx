<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" 
    Inherits="ServerControls.WebForm1" %>
   ...
   <div class="row">
    ...
    <div class="col-7">
        ...
        Sample image below:<br />
         ...
         <asp:Image runat="server" Height="300" Width="300" ID="imgUpload" ImageUrl="C:\Users\SAI PAVAN KUMAR\source\repos\ServerControls\ServerControls\Content\image.jpg" />
    </div>
